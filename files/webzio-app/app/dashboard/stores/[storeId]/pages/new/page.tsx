    ...
    return (
        <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: 32 }}>
                <h1 style={{ fontSize: '1.8rem', fontWeight: 900, color: C.text, marginBottom: 8 }}>➕ Create New Page</h1>
                <p style={{ color: C.textMuted, fontSize: '0.9rem' }}>Add a new page to your website</p>
            </div>
